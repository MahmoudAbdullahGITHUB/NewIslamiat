...
class generalInfoAdapter (private val context: Context, private val parentView: GeneralInfoFragment, private val generalInfoRV: RecyclerView?, private val generalInfoModels: ArrayList<infoModel>?) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
...
//            parentView.recyclerViewListClicked(view, adapterPosition)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        val holder = holder as generalInfoAdapter.MyItemViewHolder
