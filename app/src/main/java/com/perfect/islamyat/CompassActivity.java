...
import com.perfect.islamyat.ui.GoogleCompassFragment;
import com.perfect.islamyat.utils.Compass;
import com.perfect.islamyat.utils.GPSTracker;
...
public class CompassActivity extends AppCompatActivity {
   ...
   // private ImageView arrowView;
    ...
    //////////////////////////////////////////
        ...
        compass_rl = (RelativeLayout) findViewById(R.id.compass_rl);
        google_compass = (Button) findViewById(R.id.google_compass);

        compass_rl.setVisibility(View.VISIBLE);

        google_compass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                replaceFragments(GoogleCompassFragment.class);
            }
        });
        //////////////////////////////////////////
...
//                Toast.makeText(getApplicationContext(), getResources().getString(R.string.qibla_direction) + " " + result2 + " "+ getResources().getString(R.string.degree_from_north), Toast.LENGTH_LONG).show();
    ...
    public void replaceFragments(Class fragmentClass) {
        ...
        if (fragment != null) {
            ...
            transaction.replace(R.id.compass_container, fragment,fragmentClass.getName());
            transaction.addToBackStack("CompassActivity");
            transaction.commit();
        }
    }
        ////////////////////////////////////
